    ...
    <Navbar bg="dark" variant="dark" expand="lg">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            <Nav.Link href="bg-BG/articles">Articles</Nav.Link>
            <Nav.Link href="bg-BG/ratePassword">Rate Password</Nav.Link>
            <Nav.Link href="bg-BG/generatePassword">Generate Password</Nav.Link>
            <Nav.Link href="bg-BG/about">About</Nav.Link>
          </Nav>
        </Navbar.Collapse>
